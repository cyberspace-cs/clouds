...
description: |
  中文名：文档与决策记录。记录架构决策（ADR）、设计理由、公开 API 变更、发布说明，沉淀未来工程师与 Agent 需要的上下文。
  English: Records decisions and documentation. Use when you need to document an architecture decision (ADR) or the reasoning behind a design choice, when changing public APIs, shipping features, or when you need to record context that future engineers and agents will need to understand the codebase.
---
